  ...
  return (
    <Model isOpen={isOpen} onClose={onClose}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="">
          <p className="text-lg font-medium text-gray-900 dark:text-[#999999]">
            Profile
          </p>
          ...
          <div className="mt-5">
            <label
              htmlFor="name"
              className="block mb-1 text-sm font-medium leading-6 text-gray-900 dark:text-[#999999]"
            >
              Name
            </label>
            <input
              ...
              id="name"
              type="text"
              className=" block w-full border-2 p-2 dark:bg-transparent outline-none rounded-md border-gray-300 dark:border-gray-500 focus:border-orange-500 "
          ...
          <div className="mt-6">
            <label
              className="block text-sm font-medium leading-6 text-gray-900 dark:text-[#999999]"
              htmlFor="photo"
            >
              Photo
            </label>
          ...
          <div className="mt-5 flex items-center justify-end gap-x-3">
            <button
              disabled={isLoading}
              onClick={onClose}
              className="p-2 rounded bg-slate-200 dark:bg-[#444444] font-semibold text-sm transition hover:bg-slate-400 dark:hover:bg-[#555555]"
            >
              Cancel
            </button>
            <button
